...
import { formatPrice } from "../../utils/shopFetchers";
...
export default function ProductPage({ product }) {
  ...
  return (
    <div className="bg-blue-200 min-h-screen ">
      <h1 className="text-blue-700 text-6xl pt-32">{product.title}</h1>
    </div>
  );
}
...
//       <div className="border-t border-blue-300 mt-10 pt-10">
//         <h3 className="text-sm font-medium text-blue-800">Highlights</h3>
//         <div className="mt-4 prose prose-sm text-blue-800">
//           <ul role="list">
...
//       <div className="border-t border-blue-300 mt-10 pt-10">
//         <h3 className="text-sm font-medium text-blue-800">License</h3>
...
//       <div className="border-t border-blue-300 mt-10 pt-10">
//         <h3 className="text-sm font-medium text-blue-600">Share</h3>
