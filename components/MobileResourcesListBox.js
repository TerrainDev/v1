...
export default function MobileResourcesListBox({
  ...
  return (
    <div className="flex w-96 justify-start items-center">
      ...
      <div className="w-full px-4 py-8 z-50 top-16">
        <Listbox value={selectedTag} onChange={setSelectedTag}>
          <div className="relative mt-1">
            <Listbox.Button className="relative w-full py-2 pl-3 pr-10 text-left text-blue-600 border-2 border-blue-400 bg-gray-100 rounded-xl cursor-default focus:outline-none focus-visible:ring-2 focus-visible:ring-opacity-75 focus-visible:ring-blue-800 focus-visible:ring-offset-orange-300 focus-visible:ring-offset-2 focus-visible:border-blue-500 sm:text-sm">
