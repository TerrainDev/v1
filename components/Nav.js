...
export default function Nav() {
  return (
    <div className="w-full text-right fixed top-0 py-4 px-6 flex justify-between items-center z-50 bg-blue-200  backdrop-filter backdrop-opacity-20">
      <h1 className="text-blue-600 ">TERRAIN</h1>
